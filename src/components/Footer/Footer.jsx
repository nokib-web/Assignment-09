    ...
    <div className='bg-base-300 '>
      <footer className="footer max-w-7xl mx-auto sm:footer-horizontal bg-base-300 text-base-content p-10">
        <nav>
          ...
          <p>
            Your trusted partner in compassionate <br /> and reliable pet care.
            Providing comfort, <br /> safety, and dedicated support for every paw.
        ...
        <nav>
          <div >
            ...
            <p className="text-sm mb-4">Stay connected with our <br /> WarmPaws community </p>
